...
// 𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁 | 𝙳𝙾𝙽'𝚃 𝙲𝙷𝙰𝙽𝙶𝙴 𝙲𝚁𝙴𝙳𝙸𝚃𝚂🙂
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`25727472670@s.whatsapp.net`]
...
const timeWib = moment.tz('Africa/Nairobi').format('DD/MM HH:mm:ss')
        ...
        const timeWit = moment().tz('Africa/Cairo').format('DD/MM HH:mm:ss')
    ...
    const wit = moment.tz("Africa/Cairo").format("HH:mm:ss");
...
/*const reply = (teks) => {
			...
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/25727472670?text=hello`}}})
    ...
    const add = function (from, orangnya) {
      ...
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	...
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Klj0W15vFL225gTjgt6XAV', "groupName": `Trappy Bot Ofc.`, "footerText": "*_𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    ...
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}

// Katalog

const reply = (teks) => {

             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*Trappy*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
...
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Trappy`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/25727472670?text=hello`}}})
...
"externalAdReply": {
                ...
                "title": `Whatsapp-BOT\n𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁😎. (@nnda.krnwn_) •Instagram photos and Videos`,
...
"externalAdReply": {
                ...
                "body": `wa.me/25727472670`,

                "mediaType": "10",

                "mediaUrl": `wa.me/25727472670`,

                "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",

                "thumbnail": iye,

                "sourceUrl": `wa.me/25727472670`,
...
"mediaUrl": "https://youtube.com/channel/UCLOUU92x6cAmacsKv5VXkYg",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      ...
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "25727472670@s.whatsapp.net";
...
*Thank you for registering in the 𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁😎 Database*
...
*「 𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁*`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       ...
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               footerText: `𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁`, imageMessage: imageMsg,
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ...
        ptod = "25727472670@s.whatsapp.net"
...
╭──────────────────╮
      ...
      ✪ɪͥᴛͭsᷤᴍͫᴇͤ☚⃟т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ 
...
│  ▢ *ᴅᴇᴠᴇʟᴏʟᴇʀ* : Ŧяɑρρý҈͜͡⃢❁☺︎︎✌︎𓃻

│  ▢ *ᴏᴡɴᴇʀ* :  Ŧяɑρρý҈͜͡⃢❁☺︎︎✌︎𓃻
...
│  https://github.com/Patekyy/TRAPPY

│  

│  ❑ *ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ* :

│  https://bit.ly/3wCiyvi

│

│  ❑ *ʙᴏᴛ ɢʀᴏᴜᴘ ʟɪɴᴋ*

│  https://t.me/tracertechinc

│

│  ❑ *ᴏᴡɴᴇʀ* : 

│  https://bit.ly/3khHvas
...
case 'bugreport':
              ...
              xeon.sendMessage('25727472670@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  ...
  reply('https://www.instagram.com/trappy.ke')
...
sendButMessage(from, menu, `𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁`, [
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/channel/UCLOUU92x6cAmacsKv5VXkYg"}}})
...
case 'script':
		...
		xeon.sendMessage(from, { text: "╭─➤ *т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖   ɢɪᴛʜᴜʙ:\n│❖   https://github.com/Patekyy/TRAPPY\n│❖   ʏᴏᴜᴛᴜʙᴇ:\n│❖   https://youtube.com/channel/UCLOUU92x6cAmacsKv5VXkYg\n│❖   ᴡᴀᴛsᴀᴘᴘ ɢʀᴏᴜᴘ:\n╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             Ŧяɑρρý\n\n╭◪ *ᴄᴏᴅᴅᴇᴅ ʙʏ т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n╰─────────────────❋ཻུ۪۪⸙", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
...
//fun features by Trappy

                case 'uglycheck':

					// source code by Trappy⛔
...
case 'mygithub':
  ...
  reply('╭─➤ *т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖   ɢɪᴛʜᴜʙ:\n│❖   https://github.com/Patekyy/TRAPPY\n│❖   ʏᴏᴜᴛᴜʙᴇ:\n│❖   https://youtube.com/channel/UCLOUU92x6cAmacsKv5VXkYg\n╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             Ŧяɑρρý\n\n╭◪ *ᴄᴏᴅᴅᴇᴅ ʙʏ т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n╰─────────────────❋ཻུ۪۪⸙')
    ...
    "hydratedButtons": [

      {
        ...
        "urlButton": {
          ...
          "url": "╭─➤ *т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖   ɢɪᴛʜᴜʙ:\n│❖   https://github.com/Patekyy/TRAPPY\n│❖   ʏᴏᴜᴛᴜʙᴇ:\n│❖   https://youtube.com/channel/UCLOUU92x6cAmacsKv5VXkYg\n╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             Ŧяɑρρý\n\n╭◪ *ᴄᴏᴅᴅᴇᴅ ʙʏ т̸̢̧̟̰̠̪̐̽̈́я̵̩̘̋̋́̾̎̋̅̆͊̕ἀ̷̥̎̅̇͌ρ̶̛̻͖̑̊̄̅͂̋̓̚͜ρ̸̺̦̮̿̽͒̍̅у̸̻̰͕͔͔͉͂͋̆͜ͅͅ*\n╰─────────────────❋ཻུ۪۪⸙"
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁`, [
   ...
   case 'bc':
      ...
      case 'broadcast':
        ...
        if (!mek.key.fromMe) return;
             ...
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝚃𝚁𝙰𝙿𝙿𝚈 𝚂𝙸𝚁 BROADCASTING 」*\n\n${body.slice(4)}`})
...
Trappyx = await fetchJson(`https://bx-hunter.herokuapp.com/api/xvideosearch?query=${c}&apikey=${HunterApi}`)

reply(mess.wait)

Trappyx = Trappyx.result

ini_txt = ""

for (var x of Trappyx) {
...
case 'writelist':
  ...
  ▢ ${prefix}folioright Trappy

  ▢ ${prefix}folioleft Trappy

  ▢ ${prefix}writedown Trappy

  ▢ ${prefix}writeleft Trappy`)
...
case 'attp':
              ...
              if (args.length == 0) return reply(`Example: ${prefix + command} Trappy`)
